...
class BasePlugin:
    ...
    def onStart(self):
        ...
        if fakereading==True:
            Domoticz.Log("Plugin is in testing mode, generates a tick every 10 seconds by itself!!, Switch fakereading to off in code to disable")
    ...
    def onHeartbeat(self):
        ...
        if fakereading==True:
            Domoticz.Log("FakeReading==True: Generating testpulse, not generated by watermeter itself!")
